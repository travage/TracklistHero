...
# Adjust headers to avoid bot detection
    ...
    @app.post('/search')    # http://127.0.0.1:5000/search used in development
    def search():
        try:
...
# This originally belonged under if __name__ section, but due to a bug with Gunicorn, it needed to be instantiated outside of it
my_app = create_app()
